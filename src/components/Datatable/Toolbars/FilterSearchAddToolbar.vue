...
<template>
  ...
  >
    <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4">
      <Input class="max-w-xl" :placeholder="props.searchPlaceholder" @input="onSearch" />
      <div
        class="flex flex-col sm:flex-row justify-normal space-y-4 sm:space-y-0 space-x-0 sm:space-x-4"
      >
    ...
    <div class="action-buttons flex flex-col sm:flex-row gap-2 justify-end w-full sm:w-auto">
      <slot name="actions" />
